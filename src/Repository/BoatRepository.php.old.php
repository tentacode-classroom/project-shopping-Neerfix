...
class BoatRepositoryf
{
    ...
    public function __construct()
    {
        ...
        $boat7 = new Boat();
        $boat7->setId(1);
        $boat7->setName('Bateau de passage');
        $boat7->setDescription("Bateau de passage pour migrant. Migrant en option.");
        $boat7->setPicture("./img/14333.jpg");
        $boat7->setType("Passeur");
        $boat7->setPrice("100 K $");

        $boat8 = new Boat();
        $boat8->setId(1);
        $boat8->setName('Bateau sous-marin');
        $boat8->setDescription("Bateau de passage pour migrant. Migrant en option.");
        $boat8->setPicture("./img/maxresdefault.jpg");
        $boat8->setType("Passeur");
        $boat8->setPrice("100 K $");

        $boat9 = new Boat();
        $boat9->setId(1);
        $boat9->setName('L\'arche de Noé');
        $boat9->setDescription("Bateau de passage pour migrant. Migrant en option.");
        $boat9->setPicture("./img/noahs-ark-1.jpg");
        $boat9->setType("Passeur");
        $boat9->setPrice("100 K $");
